...
export class FirstPromoterWebhooks implements INodeType {
	description: INodeTypeDescription = {
		...
		version: 1,
		description:
			'Listen for FirstPromoter webhook events (lead_signup, lead_cancelled, promoter_signs_up, promoter_accepted, reward_created, lead_becomes_referral, fulfilment_pending). Connect to the FirstPromoter v2 node to process events with the API.',
		codex: {
