...
import { FirstPromoterWebhooks } from './nodes/FirstPromoterWebhooks/FirstPromoterWebhooks.node';
...
export const nodes = [new FirstPromoter(), new FirstPromoterLegacy(), new FirstPromoterWebhooks()];
